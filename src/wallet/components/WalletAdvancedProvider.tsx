...
function getAnimations(
  ...
  if (isSubComponentClosing) {
    return {
      ...
      mobileContainer: 'fade-out slide-out-to-bottom-1/2 animate-out duration-200 fill-mode-forwards ease-in-out',
      content: '',
    };
  }
  ...
  return {
    ...
    mobileContainer: 'fade-in slide-in-from-bottom-1/2 animate-in duration-300 ease-out',
